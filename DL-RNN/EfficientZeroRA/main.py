...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu_actor', type=int, default=13, help='batch bpu actor')
    parser.add_argument('--p_mcts_num', type=int, default=2, help='number of parallel mcts')
    parser.add_argument('--seed', type=int, default=0, help='seed (default: %(default)s)')
    parser.add_argument('--num_gpus', type=int, default=2, help='gpus available')
    parser.add_argument('--num_cpus', type=int, default=30, help='cpus available')
    ...
    parser.add_argument('--object_store_memory', type=int, default=70 * 1024 * 1024 * 1024, help='object store memory')
